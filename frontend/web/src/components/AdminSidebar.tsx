...
import { 
  ...
  Shield, FileText, Brain, Eye, Scan, Focus
} from 'lucide-react';
...
export default function AdminSidebar({ activeNav = 'home', onSidebarToggle }: AdminSidebarProps) {
  ...
  const navigationItems: NavItem[] = [
    ...
    { id: 'assessments', label: 'Daily Assessments', icon: <FileText className="w-5 h-5" />, path: '/admin/assessments', color: '#06b6d4', bgColor: '#06b6d420' },
    { id: 'sentiment', label: 'Sentiment Analysis', icon: <Brain className="w-5 h-5" />, path: '/admin/sentiment', color: '#a855f7', bgColor: '#a855f720' },
