        ...
        <div className="hero-content flex-col lg:flex-row max-w-6xl w-full">
          ...
          <div className="text-center lg:text-left lg:w-1/2">
            <h1 className="text-5xl font-bold text-base-content mb-6">
              Join <span className="text-primary">Lifora</span> Today
            </h1>
            <p className="text-xl text-base-content/90 mb-8">
              Start your personalized wellness journey with AI-powered health insights and gamified tracking.
            </p>
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-base-content/80">Free personalized health assessment</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center">
                  <svg className="w-4 h-4 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-base-content/80">Gamified wellness challenges</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center">
                  <svg className="w-4 h-4 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-base-content/80">Nutrition tracking and insights</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center">
                  <svg className="w-4 h-4 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-base-content/80">24/7 AI health companion</span>
              </div>
            </div>
          </div>
          ...
          <div className="card bg-base-100 w-full max-w-md shadow-2xl lg:w-1/2">
            <form className="card-body" onSubmit={handleSubmit}>
              <div className="text-center mb-6">
                ...
                <p className="text-base-content/70 mt-2">Join thousands on their wellness journey</p>
              </div>
              ...
              <div className="form-control mt-2">
                <label className="label cursor-pointer justify-start gap-3">
                  ...
                  <span className="label-text text-sm">I agree to the <a href="#" className="link link-primary">Terms of Service</a> and <a href="#" className="link link-primary">Privacy Policy</a></span>
                </label>
              </div>
              ...
              <div className="text-center mt-4">
                <p className="text-base-content/70">
                  ...
                  <Link to="/login" className="link link-primary font-medium ml-1">Sign in here</Link>
                </p>
              </div>
            </form>
          </div>
