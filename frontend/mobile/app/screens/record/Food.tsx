...
export default function Food() {
  ...
  return (
    ...
    >
      <View className="rounded-b-2xl p-6 mb-4 pt-16" style={{ backgroundColor: theme.colors.primary }}>
        <Text style={{ fontFamily: theme.fonts.heading, fontSize: theme.fontSizes['2xl'], color: '#FFFFFF' }} className="mb-2">Food Calorie Tracker</Text>
        <Text style={{ fontFamily: theme.fonts.body, fontSize: theme.fontSizes.base, color: '#FFFFFF' + 'CC' }} className="mb-4">
        ...
        <View className="flex-row gap-2 mb-4">
          <TouchableOpacity
            ...
            style={{ backgroundColor: viewMode === 'analyze' ? '#FFFFFF' : theme.colors.secondary + '66' }}
          >
            <Text className="text-center" style={{
              fontFamily: theme.fonts.bodyBold,
              fontSize: theme.fontSizes.base,
              color: viewMode === 'analyze' ? theme.colors.primary : '#FFFFFF'
            }}>
              Analyze Food
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            ...
            className="flex-1 py-3 rounded-lg"
            style={{ backgroundColor: viewMode === 'history' ? '#FFFFFF' : theme.colors.secondary + '66' }}
          >
            <Text className="text-center" style={{
              fontFamily: theme.fonts.bodyBold,
              fontSize: theme.fontSizes.base,
              color: viewMode === 'history' ? theme.colors.primary : '#FFFFFF'
            }}>
              History
            </Text>
          </TouchableOpacity>
        ...
        {viewMode === 'analyze' && (
          <View className="flex-row gap-2">
            <TouchableOpacity
              ...
              className="flex-1 py-3 rounded-lg"
              style={{ backgroundColor: inputMode === 'image' ? '#FFFFFF' : theme.colors.secondary + '66' }}
            >
              <Text className="text-center" style={{
                fontFamily: theme.fonts.bodyBold,
                fontSize: theme.fontSizes.base,
                color: inputMode === 'image' ? theme.colors.primary : '#FFFFFF'
              }}>
                Upload Image
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              className="flex-1 py-3 rounded-lg"
              style={{ backgroundColor: inputMode === 'manual' ? '#FFFFFF' : theme.colors.secondary + '66' }}
            >
              <Text className="text-center" style={{
                fontFamily: theme.fonts.bodyBold,
                fontSize: theme.fontSizes.base,
                color: inputMode === 'manual' ? theme.colors.primary : '#FFFFFF'
              }}>
                Manual Input
              </Text>
            </TouchableOpacity>
                ...
                {foodHistory.map((log) => (
                  ...
                  >
                    <View className="flex-row">
                      ...
                      <View className="flex-1">
                        <Text style={{ fontFamily: theme.fonts.bodyBold, fontSize: theme.fontSizes.base, color: theme.colors.text }} numberOfLines={1}>
                          {log.dishName || log.foodName}
                        </Text>
                        <Text style={{ fontFamily: theme.fonts.body, fontSize: theme.fontSizes.sm, color: theme.colors.secondary }} className="mt-1">
                          {log.calories} kcal • {log.servingSize}
                        </Text>
                        <Text style={{ fontFamily: theme.fonts.body, fontSize: theme.fontSizes.xs, color: theme.colors.secondary }} className="mt-1">
