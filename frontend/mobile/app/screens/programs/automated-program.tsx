  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.background }}>
      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: 24, paddingBottom: 48 }}>
        ...
        >
          Gemini will soon generate a dynamic program using your self-reported data, wearable trends, and goals. We will surface the schedule, nutrition prompts, and insights here.
        </Text>
        ...
        >
          ...
          >
            We are connecting Gemini outputs to program tracking. While that is being finalized, feel free to review group programs or build your own routine manually.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
